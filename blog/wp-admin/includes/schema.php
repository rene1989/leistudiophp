...
CREATE TABLE $wpdb->comments (
  ...
  comment_date datetime NOT NULL default '1990-01-01 00:00:00',
  comment_date_gmt datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE $wpdb->links (
  ...
  link_updated datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE $wpdb->posts (
  ...
  post_date datetime NOT NULL default '1990-01-01 00:00:00',
  post_date_gmt datetime NOT NULL default '1990-01-01 00:00:00',
  ...
  post_modified datetime NOT NULL default '1990-01-01 00:00:00',
  post_modified_gmt datetime NOT NULL default '1990-01-01 00:00:00',
  ...
  user_registered datetime NOT NULL default '1990-01-01 00:00:00',
  ...
  registered datetime NOT NULL default '1990-01-01 00:00:00',
  last_updated datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE $wpdb->registration_log (
  ...
  blog_id bigint(20) NOT NULL default '0',
  date_registered datetime NOT NULL default '1990-01-01 00:00:00',
  PRIMARY KEY  (ID),
  KEY IP (IP)
) $charset_collate;
...
CREATE TABLE $wpdb->signups (
  ...
  user_email varchar(100) NOT NULL default '',
  registered datetime NOT NULL default '1990-01-01 00:00:00',
  activated datetime NOT NULL default '1990-01-01 00:00:00',
