	...
	<div id="post-body">
		<div <?php post_class('post-single'); ?>>
			...
			<div id="article">
				...
				<?php } ?>
				<?php the_content(); 
				the_tags('<p class="post-tags"><span>'.__('Tags:','simpleo').'</span> ','','</p>');
				wp_link_pages( array(
					'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'simpleo' ) . '</span>',
					'after'       => '</div>',
					'link_before' => '<span>',
					'link_after'  => '</span>',
				) );
