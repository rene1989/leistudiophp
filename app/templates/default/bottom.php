	  		...
	  		<div class="row">
	  			...
	  			<div class="col-md-12">
					...
					<div class="col-sm-12 col-md-7">
		  				<ul>	                	
	                		<li><a href="<?php echo DIR;?>company#press"><?php echo $data['bottom_menu_label_press'];?></a></li>
	                		<li><a href="<?php echo DIR;?>company#support"><?php echo $data['bottom_menu_label_support'];?></a></li>
	                		<li><a href="<?php echo DIR;?>blog"><?php echo $data['bottom_menu_label_blog'];?></a></li>
	                		<li><a href="<?php echo DIR;?>company#recruit"><?php echo $data['bottom_menu_label_recruit'];?></a></li>
	                		<li><a href="<?php echo DIR;?>company#policy"><?php echo $data['bottom_menu_label_policy'];?></a></li>
                		</ul>
                	</div>
	  			</div>
	  		</div>
